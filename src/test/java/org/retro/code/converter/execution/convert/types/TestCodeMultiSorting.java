...
/**
 * This test will sort the source code sections into a different order
 * on the target.
 */

public class TestCodeMultiSorting {
    ...
    private static final String EXPECTED = "  public functionToTarget2() { object2 }" +
                                           "  public functionToTarget1() { object1 }";
    ...
    public void init() {
        ...
        CODE_SECTION_1.setTargetOrder(2);
        ...
        CODE_SECTION_2.setTargetFileId(1);
    ...
    @Test
    public void testSimpleMultiTargets() {
