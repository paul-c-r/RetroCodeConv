 ...
 */
public class CodeConversionException extends RuntimeException {
    /**
     * This is thrown if there is an issue with the conversion.
     * It is caught by {@link ExceptionAspect}
     *
     * @param cause A wrapped checked exception indicating the cause.
     */
    public CodeConversionException(Throwable cause) {
        super(cause);
    }
}
